...
class EFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTeme = InputDecorationTheme(
    errorMaxLines: 3,
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    errorStyle: const TextStyle().copyWith(fontStyle: FontStyle.normal, color: Colors.redAccent),
